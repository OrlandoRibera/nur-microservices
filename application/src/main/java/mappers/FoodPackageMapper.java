...
public final class FoodPackageMapper {
	...
	public static FoodPackageDTO from(FoodPackage foodPackage) {
		...
		return new FoodPackageDTO(foodPackage.getId().toString(), foodPackage.getRecipeId().toString(), foodPackage.getClientId().toString(), foodPackage.getAddress(), foodDTOS, foodPackage.getStatus());
	}
}
